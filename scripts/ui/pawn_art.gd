...
const EXTENT := {
	...
	"E01": Vector2(1.00, 0.59), "E02": Vector2(1.00, 0.93), "E03": Vector2(1.00, 0.45),
	"E04": Vector2(1.00, 0.49), "E05": Vector2(1.00, 0.90), "E06": Vector2(1.00, 0.44),
	"E07": Vector2(1.00, 0.81), "E08": Vector2(1.00, 0.39), "E09": Vector2(1.00, 0.60),
	"E10": Vector2(1.00, 0.50), "B1": Vector2(1.00, 0.46), "B2": Vector2(1.00, 0.34),
