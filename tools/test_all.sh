...
cd "$(dirname "$0")/.."
SUITES="engine_smoke font_coverage_test data_policy_test keywords_test save_migrate_test boss_test phase4_test meta_test run_flow_test ui_smoke layout_test screens_crawl charselect_input_test drag_input_test"
FAILED=0
for t in $SUITES; do
  printf '%-24s ' "$t"
